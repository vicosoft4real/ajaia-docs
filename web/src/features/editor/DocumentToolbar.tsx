...
import { INSERT_ORDERED_LIST_COMMAND, INSERT_UNORDERED_LIST_COMMAND, ListNode, $isListNode } from "@lexical/list";
...
export function DocumentToolbar() {
  ...
  const list=(ordered:boolean)=>{ensureSelection();editor.dispatchCommand(ordered?INSERT_ORDERED_LIST_COMMAND:INSERT_UNORDERED_LIST_COMMAND,undefined)};
