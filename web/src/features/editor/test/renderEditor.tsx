...
export function renderEditor(initialContent: string, contentFormat: LexicalDocumentEditorProps["contentFormat"]) {
  if (!(Node.prototype as Node & { getBoundingClientRect?: () => DOMRect }).getBoundingClientRect) {
    (Node.prototype as Node & { getBoundingClientRect: () => DOMRect }).getBoundingClientRect = () => new DOMRect();
  }
